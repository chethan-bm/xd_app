...
class XDMotorControl1 extends StatelessWidget {
  XDMotorControl1({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromSize(
            bounds: Rect.fromLTWH(-22.0, 497.0, 423.0, 220.0),
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(37.0, 361.0, 58.0, 58.0),
            size: Size(375.0, 812.0),
            pinLeft: true,
            fixedWidth: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(143.0, 267.0, 99.0, 21.0),
            size: Size(375.0, 812.0),
            fixedWidth: true,
            fixedHeight: true,
            child: Text(
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(138.0, 384.0, 99.0, 21.0),
            size: Size(375.0, 812.0),
            fixedWidth: true,
            fixedHeight: true,
            child: Text(
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(77.0, 508.0, 237.0, 31.0),
            size: Size(375.0, 812.0),
            fixedWidth: true,
            fixedHeight: true,
            child: Text(
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(246.8, 563.9, 58.2, 27.5),
            size: Size(375.0, 812.0),
            fixedWidth: true,
            fixedHeight: true,
            child:
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(77.0, 562.0, 136.0, 31.0),
            size: Size(375.0, 812.0),
            fixedWidth: true,
            fixedHeight: true,
            child: Text(
