...
class XDMotorControl4 extends StatelessWidget {
  XDMotorControl4({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromSize(
            bounds: Rect.fromLTWH(-22.0, 490.0, 423.0, 220.0),
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(0.0, 122.0, 375.0, 292.0),
            size: Size(375.0, 812.0),
            pinLeft: true,
            pinRight: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(37.0, 134.0, 58.0, 58.0),
            size: Size(375.0, 812.0),
            pinLeft: true,
            fixedWidth: true,
            fixedHeight: true,
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(145.0, 150.0, 89.0, 21.0),
            size: Size(375.0, 812.0),
            fixedWidth: true,
            fixedHeight: true,
            child: Text(
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(138.0, 380.0, 99.0, 21.0),
            size: Size(375.0, 812.0),
            fixedWidth: true,
            fixedHeight: true,
            child: Text(
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(77.0, 502.0, 237.0, 31.0),
            size: Size(375.0, 812.0),
            fixedWidth: true,
            fixedHeight: true,
            child: Text(
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(246.8, 558.0, 58.2, 27.5),
            size: Size(375.0, 812.0),
            fixedWidth: true,
            fixedHeight: true,
            child:
